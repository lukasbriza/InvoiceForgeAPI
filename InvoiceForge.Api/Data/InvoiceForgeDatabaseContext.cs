...
namespace InvoiceForgeApi.Data
{
    public class InvoiceForgeDatabaseContext : DbContext
    {
        ...
        public DbSet<InvoiceAddressCopy> InvoiceAddressCopy { get; set;} = null!;
        public DbSet<InvoiceEntityCopy> InvoiceEntityCopy { get; set;} = null!;
        public DbSet<InvoiceUserAccountCopy> InvoiceUserAccountCopy { get; set;} = null!;
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<InvoiceUserAccountCopy>()
                .Property(u => u.Id)
                .ValueGeneratedOnAdd();
            builder.Entity<InvoiceEntityCopy>()
                .Property(u => u.Id)
                .ValueGeneratedOnAdd();
            builder.Entity<InvoiceAddressCopy>()
                .Property(u => u.Id)
                .ValueGeneratedOnAdd();
            ...
            builder.Entity<Invoice>().HasOne(a => a.InvoiceUserAccountCopy).WithMany(b => b.Invoices).OnDelete(DeleteBehavior.ClientNoAction);
            ...
            //InvoiceUserAccountCopy on delete behavior
            builder.Entity<InvoiceUserAccountCopy>().HasOne(a => a.Bank).WithMany(b => b.UserAccountCopies).OnDelete(DeleteBehavior.ClientNoAction);
